...
import weberJson from '../../data/personas/weber.json';
import trompJson from '../../data/personas/tromp.json';
import kubJson from '../../data/personas/kub.json';
import metzJson from '../../data/personas/metz.json';
import rippinJson from '../../data/personas/rippin.json';
import danielJson from '../../data/personas/daniel.json';
import franeckiJson from '../../data/personas/franecki.json';
import larsonErichJson from '../../data/personas/larson_erich.json';
import marvinJson from '../../data/personas/marvin.json';
...
// Map FHIR bundles onto featured patients by ID
